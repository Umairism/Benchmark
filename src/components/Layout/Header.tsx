...
import { BookOpen, User, LogOut, Settings, PlusCircle, Home, MessageCircle } from 'lucide-react';
            ...
            {user ? (
              <>
                <div className="hidden md:block text-sm text-gray-600">
                  Welcome back, <span className="font-medium text-blue-600">{user.full_name || user.email.split('@')[0]}</span>!
                </div>
